    ...
    <canvas id="canvas" style="background:url(http://clfile.zggen.cn/20231120/5c406dea56f94e7a8862ce254a053b09.jpg) no-repeat center center / cover"></canvas>
		<div class="login_view">
			<el-form :model="loginForm" class="login_form">
				<div class="title_view">基于OpenCV和Python的人脸识别系统登录</div>
				...
				<div v-if="loginType==1" @click="loginType=2" class="face">面容ID登录</div>
				<div v-if="loginType==2" @click="loginType=1" class="face">账号密码登录</div>
			</el-form>
		</div>
