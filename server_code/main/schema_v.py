...
def schemaName_upload(request, fileName):
    ...
    '''
    if request.method in ["POST", "GET"]:
        return HttpResponseRedirect  ("/{}/file/{}".format(schemaName,fileName))
...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider${spiderSchemaName} && scrapy crawl "+tableName+"Spider -a databaseName=cl3286667"
        # Windows
